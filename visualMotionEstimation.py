###################################################################################################################################################################
#
#   @witwiki #2331.23062014
#   Basic 2D Visual Motion Estimation for the AR Parrot
#   using the 'quadrotor.command' package and an Extended Kalman Filter (EKF)
#
...
class UserCode:
    ...
    def correctState(self, K, x_predicted, z, z_predicted):
        ...
        ##### ---- Alternative way by normalization
